    ...
    <div class="min-h-screen flex items-center justify-center bg-[#FDF2F5] px-4 py-12 font-display">
        <div class="w-full max-w-xl bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-white/50 relative overflow-hidden">
            ...
            <div class="relative z-10 text-center mb-8">
                ...
                <div class="relative size-28 mx-auto mb-4 group cursor-pointer" @click="triggerFileInput">
                    <!-- Image render -->
                    <div class="size-full bg-[#fcf8f9] rounded-full flex items-center justify-center text-white glow-primary border-4 border-white shadow-lg overflow-hidden bg-cover bg-center bg-no-repeat transition-all group-hover:brightness-95"
                    ...
                    >
                        ...
                        <div v-if="isUploadingAvatar" class="absolute inset-0 bg-black/40 flex items-center justify-center">
                            <span class="material-symbols-outlined animate-spin text-white text-3xl">progress_activity</span>
                        </div>
                    </div>
                    ...
                    <div class="absolute inset-0 bg-black/35 text-white rounded-full opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center transition-opacity border-4 border-transparent">
                        ...
                        <span class="text-[9px] font-black uppercase tracking-wider mt-1">Thay đổi</span>
                    </div>
                </div>
                ...
                <p class="text-gray-400 text-sm mt-1">Thay đổi thông tin tài khoản của bạn</p>
            ...
            <form @submit.prevent="handleUpdateProfile" class="space-y-5 relative z-10">
                <!-- Username (ReadOnly) -->
                <div class="space-y-1.5 text-left">
                    ...
                    <div class="relative">
                        ...
                        <input :value="authStore.user" type="text" readonly class="w-full bg-[#fcf8f9] border-none rounded-2xl py-4 pl-12 pr-4 font-bold text-gray-400 cursor-not-allowed outline-none text-sm" />
                    </div>
                </div>
                ...
                <div class="space-y-1.5 text-left">
                    ...
                    <div class="relative">
                        ...
                        <input v-model="displayName" type="text" class="w-full bg-[#fcf8f9] border-none rounded-2xl py-4 pl-12 pr-4 font-bold text-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all text-sm" required />
                    </div>
                </div>
                ...
                <div class="space-y-1.5 text-left">
                    ...
                    <div class="relative">
                        ...
                        <input v-model="newPassword" type="password" placeholder="••••••••" class="w-full bg-[#fcf8f9] border-none rounded-2xl py-4 pl-12 pr-4 font-bold text-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder:font-normal placeholder:text-gray-300 text-sm" />
                    </div>
                </div>
                ...
                <div class="space-y-1.5 text-left">
                    ...
                    <div class="relative">
                        ...
                        <input v-model="confirmPassword" type="password" placeholder="••••••••" class="w-full bg-[#fcf8f9] border-none rounded-2xl py-4 pl-12 pr-4 font-bold text-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder:font-normal placeholder:text-gray-300 text-sm" />
                    </div>
                </div>
                ...
                <!-- Save Button -->
                <button :disabled="isLoading" type="submit" class="w-full bg-primary text-white font-bold py-4 rounded-full shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all text-xs flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed">
